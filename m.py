...
bot = telebot.TeleBot('7240194618:AAFfqpHZNse_7jKlmSn3Kx1ZbRz5p-UI38M ')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝒀𝒐𝒖 𝒉𝒂𝒗𝒆 𝒏𝒐𝒕 𝒂𝒄𝒄𝒆𝒔𝒔 𝒚𝒆𝒕 𝒈𝒆𝒕 𝒏𝒐𝒘 𝒂𝒄𝒄𝒆𝒔𝒔 𝒇𝒓𝒐𝒎:- @GODNEXTYT"
...
✅ Usage: /remove <userid>'''
        ...
        response = "🔐 𝐤𝐞𝐲 𝐞𝐱𝐩𝐢𝐫𝐞:- @GODNEXTYT ❤️."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. ᴅᴍ ᴛᴏ ʙᴜʏ ᴀᴄᴄᴇss ᴄʟɪᴄᴋ ʜᴇʀᴇ sᴇᴇ ᴅ-ᴅᴏs /plan 1⃣ ᴅᴀʏ ғʀᴇᴇ ᴛʀɪᴀʟ ᴀʟᴏsᴏ ᴀᴠᴀɪʟᴀʙʟᴇ:- @GODNEXTYT / @GODNEXTYT 🤡")
...
💥 /plan : Our rates are cheap, you can afford the plans Dm @GODNEXTYT.
...
✅ That Was Get Your Access From :- @GODNEXTYT☠️
